...
<form action=" " autocomplete="off" method="post" class="emeon-form form-password" enctype="multipart/form-data"
      name="emeon-form">
	...
	<fieldset>
		...
		<input id="current-pass" class="view-toggle" name="current" type="password" autocomplete="false"

...
global $emeon_a13;
$product_variant = $emeon_a13->get_option( 'shop_products_variant' );
$product_subvariant = $product_variant === 'under'? ('products_subvariant_'.$emeon_a13->get_option( 'shop_products_subvariant' ) ) : '';
...
$lazy_load_mode  = $emeon_a13->get_option( 'shop_lazy_load_mode' );

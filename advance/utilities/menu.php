...
if(!function_exists('emeon_add_menu_parent_class')){
	/**
	 ...
	 * @return array
	 */
	function emeon_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'emeon_add_menu_parent_class' );


if(!function_exists('emeon_page_menu')){
	/**
	 ...
	 */
	function emeon_page_menu($only_check = false) {
        global $post;
        ...
        if($there_is_menu){
            ...
            $list_pages_params['walker'] = new EMEON_list_pages_walker;
